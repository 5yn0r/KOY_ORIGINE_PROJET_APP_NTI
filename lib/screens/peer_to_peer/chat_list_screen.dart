  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        final chatRooms = (snapshot.data ?? []).where((chatRoom) {
          final otherUser = chatRoom['otherUser'] as P2PUser;
        ...
        if (chatRooms.isEmpty) {
          return _ChatEmptyState(
            ...
            subtitle: widget.searchQuery.isEmpty
                ? 'Ouvrez un profil dans Peers pour démarrer une discussion.'
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            final otherUser = chatRoom['otherUser'] as P2PUser;
            final lastMessage = chatRoom['lastMessage'] as String?;
            final timestamp = chatRoom['timestamp'] as DateTime?;
            ...
            return Card(
              ...
              child: ListTile(
                ...
                leading: _ChatAvatar(user: otherUser),
                title: Row(
                  children: [
                    Expanded(
                      child: Text(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ChatScreen(user: otherUser),
                    ),
                  );
                },
              ),
